...
public class ArrayHelper {
    ...
    public static void iconListSetter(String text, ImageView image) {
        switch(text) {
            case "Bowser":
                image.setImageResource(R.drawable.marioicon);
                break;
            case "Captain Falcon":
                image.setImageResource(R.drawable.fzeroicon);
                break;
            case "Donkey Kong":
            ...
            case "Dr. Mario":
                ...
                break;
            case "Falco":
                image.setImageResource(R.drawable.falcoicon);
                break;
            case "Fox":
                image.setImageResource(R.drawable.foxicon);
                break;
            case "Ganondorf":
                image.setImageResource(R.drawable.zeldaicon);
                break;
            case "Ice Climbers":
                image.setImageResource(R.drawable.icicon);
                break;
            case "Jigglypuff":
                image.setImageResource(R.drawable.jiggsicon);
                break;
            case "Kirby":
            ...
            case "Mario":
                ...
                break;
            case "Luigi":
                image.setImageResource(R.drawable.luigiicon);
                break;
            case "Marth":
                image.setImageResource(R.drawable.marthicon);
                break;
            case "Mewtwo":
                image.setImageResource(R.drawable.pokemonicon);
                break;
            case "Mr. Game & Watch":
                image.setImageResource(R.drawable.gandwicon);
                break;
            case "Ness":
                image.setImageResource(R.drawable.ebicon);
                break;
            case "Pichu":
                image.setImageResource(R.drawable.pikaicon);
                break;
            case "Pikachu":
                image.setImageResource(R.drawable.pikaicon);
                break;
            case "Princess Peach":
                image.setImageResource(R.drawable.peachicon);
                break;
            case "Princess Zelda":
                image.setImageResource(R.drawable.zeldaicon);
                break;
            case "Roy":
                image.setImageResource(R.drawable.royicon);
                break;
            case "Samus Aran":
                image.setImageResource(R.drawable.metroidicon);
                break;
            case "Sheik":
                image.setImageResource(R.drawable.zeldaicon);
                break;
            case "Yoshi":
                image.setImageResource(R.drawable.yoshiicon);
                break;
            case "Young Link":
                image.setImageResource(R.drawable.linkicon);
                break;
